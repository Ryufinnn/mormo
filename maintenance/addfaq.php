          ...
          <ul class="sidebar-menu">
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="addfaq.php"><span class="glyphicon glyphicon-asterisk"></span><span>FAQ</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <form action="addfaq.php" method="post">
            ...
            <button type="submit" name="simpan" value="submit" class="btn btn-info">Tambah</button>
          </form>
          ...
          if (isset($_POST['simpan'])){
            ...
            $jawab1 = $_POST['jawab'];
            $kode = array("'", "?", "!", "-", "+", "&", "%", "@", "*", "~", "|", "\n");
            $unicode = array("%27", "%3F", "%21", "%2D", "%2B", "%26", "%25", "%40", "%2A", "%7E", "%7E", "<br/>");
            $tanya = str_replace($kode, $unicode, $tanya1);
            $jawab = str_replace($kode, $unicode, $jawab1);
            $query = mysql_query("INSERT INTO `faq`(`tanya`, `jawab`) VALUES ('$tanya','$jawab')");
            mysql_query($query);
            echo"<script>alert('FAQ berhasil ditambah!');</script>";
          }
          ?>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
