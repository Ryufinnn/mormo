...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Ubah | Slide Show Carousel</title>
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="carousel.php"><span class="glyphicon glyphicon-asterisk"></span><span>Slide Show Carousel</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <a href="../index.php" target="_blank" class="btn btn-success btn-large" role="button"><span class="glyphicon glyphicon-arrow-right"></span> Cek Slide Show Home</a>
          <p>
            <h2>Edit Slide Show Carousel</h2>
            <br/>
          </p>
            ...
            <div class="form-group">
              <label>Foto</label>
                <div class="input-group">
                  ...
                  <input type="file" class="form-control" name="nama_carousel" id="nama_carousel" onchange="PreviewImage();"/>
                </div>
            </div>
            <div class="form-group">
              <label>Gambar ke-</label>
                <div class="input-group">
                   <select name="id_carousel">
          ...
          <?php
          $nama_carousel = $_POST['nama_carousel'];
          $id_carousel = $_POST['id_carousel'];
          $wkt_upload = date('Y-m-d H:i:s');
          if (isset($_POST['simpan'])){
            $fileName = $_FILES['nama_carousel']['name'];
            $query = mysql_query("UPDATE `carousel` SET `nama_carousel`='$fileName',`wkt_upload`='$wkt_upload' WHERE `id_carousel`='$id_carousel'");
            mysql_query($query);
            move_uploaded_file($_FILES['nama_carousel']['tmp_name'], "../images/".$_FILES['nama_carousel']['name']);
