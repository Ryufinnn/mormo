...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Hapus | Gelang Karet Kompak</title>
    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class='active'><a href="delgelkp.php"><span class="glyphicon glyphicon-asterisk"></span><span>Gelang Karet Kompak</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <p>
            <h2>Hapus Gambar Gelang Karet Kompak</h2>
            <br/>
          </p>
          <table class="table">
            <thead>
            ...
            ?> 
              <tr> 
                <th scope="row"><img src="../images/gelKompak/<?php echo $data['nama_gelkompak'];?>" height="50px" width="50px"></th> 
                <td><?php
                $teksAwal = $data['desk_gelkompak'];
                $unicode = array("%27", "%3F", "%21", "%2D", "%2B", "%26", "%40", "%2A", "%7E", "%7E");
                $kode = array("'", "?", "!", "-", "+", "&", "@", "*", "~", "|");
                $nama_gelkompak = str_replace($unicode, $kode, $teksAwal); 
                echo $nama_gelkompak;
                ?></td> 
                <td><a href="delgelkp1.php?id_gelkompak=<?php echo $data['id_gelkompak'];?> " class="btn btn-default btn-xs" role="button" onclick="return confirm('Yakin ingin menghapus item ini?');"><span class="glyphicon glyphicon-trash"></span> Hapus</a></td> 
              </tr>
            <?php
            }
            ?> 
