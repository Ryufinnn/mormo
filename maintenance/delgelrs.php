...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Hapus | Gelang Ready Stock</title>
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="delgelrs.php"><span class="glyphicon glyphicon-asterisk"></span><span>Gelang Ready Stock</span></a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <p>
            <h2>Hapus Gelang Ready Stock</h2>
            <br/>
          </p>
          <table class="table">
            <thead>
            ...
            <tbody>
            <?php
            $query = mysql_query("SELECT * from `gel_readystock`");
            while ($data =  mysql_fetch_array($query)) {
            ?> 
              <tr> 
                <th scope="row"><img src="../images/gelReady/<?php echo $data['nama_foto'];?>" height="100px" width="100px"></th> 
                <td><?php
                $teksAwal = $data['nama_gelready'];
                $unicode = array("%27", "%3F", "%21", "%2D", "%2B", "%26", "%40", "%2A", "%7E", "%7E");
                $kode = array("'", "?", "!", "-", "+", "&", "@", "*", "~", "|");
                $nama_gelready = str_replace($unicode, $kode, $teksAwal); 
                echo $nama_gelready;
                ?></td> 
                <td><a href="delgelrs1.php?id_gelready=<?php echo $data['id_gelready'];?>" class="btn btn-default btn-xs" role="button" onclick="return confirm('Yakin ingin menghapus item ini?');"><span class="glyphicon glyphicon-trash"></span> Hapus</a></td> 
              </tr>
            <?php
            }
            ?> 
