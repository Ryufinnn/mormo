      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <table class="table">
            ...
            <tbody>
            <?php
            $query = mysql_query("SELECT * from `gel_readystock` ORDER BY `wkt_upload` desc");
            while ($data =  mysql_fetch_array($query)) {
            ?> 
              <tr> 
                <th scope="row"><img src="../images/gelReady/<?php echo $data['nama_foto'];?>" height="50px" width="50px"></th> 
                <td><?php
                ...
                echo $teksFix;
                ?></td> 
                <td><a href="dtlgelrs1.php?id_gelready=<?php echo $data['id_gelready'];?>" class="btn btn-default btn-xs" role="button"><span class="glyphicon glyphicon-plus"></span> Tambah Gambar</a></td> 
              </tr>
            <?php
            }
            ?> 
