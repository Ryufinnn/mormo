    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="editabout.php"><span class="glyphicon glyphicon-asterisk"></span><span>About Us</span></a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <a href="../about.php" target="_blank" class="btn btn-success btn-large" role="button"><span class="glyphicon glyphicon-arrow-right"></span> Cek Halaman About Us</a>
          <p>
            <h2>Edit About Us</h2>
            <br/>
          </p>
            ...
            <div class="form-group">
              <label>History</label>
                <div class="input-group">
                  <textarea class="form-control" rows="3" name="history" id="history" required maxlenght="3000"></textarea>
                </div>
            </div>
            <div class="form-group">
              <label>Visi</label>
                <div class="input-group">
                  <textarea class="form-control" rows="3" name="visi" id="visi" required maxlenght="1000"></textarea>
                </div>
            </div>
            <div class="form-group">
              <label>Misi</label>
                <div class="input-group">
                  <textarea class="form-control" rows="3" name="misi" id="misi" required maxlenght="1000"></textarea>
                </div>
            </div>
            <div class="form-group">
              <label>e-Mail</label>
                <div class="input-group">
                  <input type="text" size="100px" class="form-control" name="email" id="email" placeholder="WARNING! masukkan alamat situs tanpa menggunakan tulisan http://" required maxlength="40"/>
                </div>
            </div>
            <div class="form-group">
              <label>Facebook</label>
                <div class="input-group">
                  <input type="text" size="100px" class="form-control" name="facebook" id="facebook" placeholder="WARNING! masukkan alamat situs tanpa menggunakan tulisan http://" required maxlength="40"/>
                </div>
            </div>
            <div class="form-group">
              <label>Twitter</label>
                <div class="input-group">
                  <input type="text" size="100px" class="form-control" name="twitter" id="twitter" placeholder="WARNING! masukkan alamat situs tanpa menggunakan tulisan http://" required maxlength="40"/>
                </div>
            </div>
            <div class="form-group">
              <label>Instagram</label>
                <div class="input-group">
                  <input type="text" size="100px" class="form-control" name="ig" id="ig" placeholder="WARNING! masukkan alamat situs tanpa menggunakan tulisan http://" required maxlength="40"/>
                </div>
            </div>
            <button type="submit" name="ubah" value="submit" class="btn btn-info">Ubah</button>
          </form>

          <?php
          if (isset($_POST['ubah'])){
            $kode = array("'", "?", "!", "-", "+", "&", "@", "*", "~", "|", "\n");
            $unicode = array("%27", "%3F", "%21", "%2D", "%2B", "%26", "%40", "%2A", "%7E", "%7E", "<br/>");
            $history1 = $_POST['history'];
            $history = str_replace($kode, $unicode, $history1);
            $visi1 = $_POST['visi'];
            $visi = str_replace($kode, $unicode, $visi1);
            $misi1 = $_POST['misi'];
            $misi = str_replace($kode, $unicode, $misi1);
            $email1 = $_POST['email'];
            $email = str_replace($kode, $unicode, $email1);
            $facebook1 = $_POST['facebook'];
            $facebook = str_replace($kode, $unicode, $facebook1);
            $twitter1 = $_POST['twitter'];
            $twitter = str_replace($kode, $unicode, $twitter1);
            $ig1 = $_POST['ig'];
            $ig = str_replace($kode, $unicode, $ig1);
            //$tanya1 = $_POST['tanya'];
            //$jawab1 = $_POST['jawab'];
            //$tanya = str_replace($kode, $unicode, $tanya1);
            //$jawab = str_replace($kode, $unicode, $jawab1);
            $query = mysql_query("UPDATE `about` SET `history` = '$history', `visi` = '$visi', `misi` = '$misi', `email` = '$email', `facebook` = '$facebook', `twitter` = '$twitter', `ig` = '$ig'");
            echo"<script>alert('FAQ berhasil diubah!');</script>";
          }
          ?>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
