    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="editfaq.php"><span class="glyphicon glyphicon-asterisk"></span><span>FAQ</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <a href="../howto.php" target="_blank" class="btn btn-success btn-large" role="button"><span class="glyphicon glyphicon-arrow-right"></span> Cek Halaman FAQs</a>
          <p>
            <h2>Edit FAQ</h2>
            <br/>
          </p>
          <?php
            ...
            /*
            $kueri = mysql_query("SELECT * FROM `faq` WHERE `id_faq` = '$id_faq'");
            $baca = mysql_fetch_array($kueri);

            $quest1 = $baca['tanya'];
            $bla = str_replace($unicode, $kode, $quest1);
            echo "<p>$bla</p><br>";

            $ans1 = $baca['jawab'];
            $vla = str_replace($unicode, $kode, $ans1);
            echo "$vla";*/
            ?>
          <form action="editfaq.php?id_faq=<?php echo $id_faq;?>" method="post">
            <div class="form-group">
              <label>Pertanyaan</label>
                <div class="input-group">
                  <textarea class="form-control" rows="3" name="tanya" id="tanya" required maxlenght="1000"></textarea>
                </div>
            </div>
            <div class="form-group">
              <label>Jawaban</label>
                <div class="input-group">
                  <textarea class="form-control" rows="3" name="jawab" id="jawab" required maxlenght="3000"></textarea>
                </div>
            </div>
          ...
          if (isset($_POST['ubah'])){
            ...
            $query = mysql_query("UPDATE `faq` SET `tanya` = '$tanya', `jawab` = '$jawab' WHERE `id_faq` = '$id_faq'");
