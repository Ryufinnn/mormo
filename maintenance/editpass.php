        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="editpass.php"><span class="glyphicon glyphicon-asterisk"></span><span>Ubah Password</span></a></li>
              </ul>
            </li>
          </ul>
        </section>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="form-group">
              <label>Username</label>
                <div class="input-group">
                  <input type="text" size="100px" class="form-control" name="username" id="username" required maxlength="16"/>
                </div>
            </div>
            <div class="form-group">
              <label>Password Lama</label>
                <div class="input-group">
                  <input type="password" size="100px" class="form-control" name="oldpw" id="oldpw" required maxlength="16"/>
                </div>
            </div>
            <div class="form-group">
              <label>Password Baru</label>
                <div class="input-group">
                  <input type="password" size="100px" class="form-control" name="newpw" id="newpw" required maxlength="16"/>
                </div>
            </div>
            <button type="submit" name="ubah" value="submit" class="btn btn-info">Edit Password</button>
          </form>
          ...
          if (isset($_POST['ubah'])){
            ...
            $query1 = mysql_query("SELECT * FROM `administrator` WHERE `username`='$username' && `password`='$oldpw'");
            $query2= mysql_query("UPDATE `administrator` SET `password` = '$newpw' WHERE `username`='$username'");
