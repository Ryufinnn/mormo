    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="katproduk.php"><span class="glyphicon glyphicon-asterisk"></span><span>Kategori Produk</span></a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <form action="katproduk.php" method="post">
            <div class="form-group">
              <label>Nama Kategori</label>
                <div class="input-group">
                  <input type="text" size="20px" class="form-control" name="nama" id="nama" required maxlength="20"/>
                </div>
            </div>
          ...
          if (isset($_POST['simpan'])){
            ...
            $nama = str_replace($kode, $unicode, $nama1);
            $query = mysql_query("INSERT INTO `kategori`(`nama`) VALUES ('$nama')");
            mysql_query($query);
            echo"<script>alert('Kategori baru berhasil ditambah!');</script>";
          }
          ?>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
