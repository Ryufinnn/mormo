...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Tambah | Detail Lookbook</title>
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="lookbooklist.php"><span class="glyphicon glyphicon-asterisk"></span><span>Detail Look Book</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <p>
            <h2>Upload Gambar Detail Lookbook</h2>
            <br/>
          </p>
          <form action="lookbook1.php?id_lookbook=<?php $id_lookbook = $_GET['id_lookbook']; echo $id_lookbook; ?>" method="post" enctype="multipart/form-data">
            <div class="form-group" id="form_foto">
              <label>Foto</label>
                <div class="input-group">
                  <input type="file" class="form-control" name="foto_detail[]" id="foto_detail" onchange="PreviewImage();"/>
                </div>
            </div>
          ...
          if (isset($_POST['simpan'])){
            ...
            $jumlahFile = count($_FILES['foto_detail']['name']);
            for($i=0; $i<$jumlahFile; $i++){
              $fileName = $_FILES['foto_detail']['name'][$i];
              $query = mysql_query("INSERT INTO `lookbook_detail`(`id_lookbook`, `foto_detail`, `wkt_upload`) VALUES ('$id_lookbook','$fileName', '$wkt_upload')");
              mysql_query($query);
              move_uploaded_file($_FILES['foto_detail']['tmp_name'][$i], "../images/detailLookbook/".$_FILES['foto_detail']['name'][$i]);
            }
