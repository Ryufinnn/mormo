...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Tambah | Lookbook Detail</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <p>
            <h2>Daftar Lookbook yang Sudah Ada</h2>
            <br/>
          </p>
          <table class="table">
            <thead>
            ...
            <tbody>
            <?php
            $query = mysql_query("SELECT * from `lookbook` ORDER BY `wkt_upload` asc");
            while ($data =  mysql_fetch_array($query)) {
            ?> 
              <tr> 
                <th scope="row"><img src="../images/headerLookbook/<?php echo $data['foto_header'];?>" height="50px" width="50px"></th> 
                <td><?php echo $data['judul'];?></td> 
                <td><a href="lookbook1.php?id_lookbook=<?php echo $data['id_lookbook'];?>" class="btn btn-default btn-xs" role="button"><span class="glyphicon glyphicon-plus"></span> Tambah Gambar Detail</a></td> 
              </tr>
            <?php
            }
            ?> 
