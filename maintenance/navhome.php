    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class='active'><a href="navhome.php"><span class="glyphicon glyphicon-asterisk"></span><span>Navigasi Home</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <a href="../index.php" target="_blank" class="btn btn-success btn-large" role="button"><span class="glyphicon glyphicon-arrow-right"></span> Cek Navigasi Home</a>
          <p>
            <h2>Ubah Gambar Navigasi Home</h2>
            <br/>
          </p>
          <form action="navhome.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label>Foto</label>
                <div class="input-group">
                  <img id="uploadPreview"/><br>
                  <input type="file" class="form-control" name="nama_navhome" id="nama_navhome" onchange="PreviewImage();"/>
                </div>
            </div>
            <div class="form-group">
              <label>Pilihan Gambar</label>
                <div class="input-group">
                   <select name="id_navhome">
                    <option value="1">Gelang Karet Kompak</option>
                    <option value="2">Gelang Ready Stock</option>
                  </select> 
                </div>
            </div>
          ...
          <?php
          $nama_navhome = $_POST['nama_navhome'];
          $id_navhome = $_POST['id_navhome'];
          $wkt_upload = date('Y-m-d H:i:s');
          if (isset($_POST['simpan'])){
            $fileName = $_FILES['nama_navhome']['name'];
            $query = mysql_query("UPDATE `navhome` SET `nama_navhome`='$fileName',`wkt_upload`='$wkt_upload' WHERE `id_navhome`='$id_navhome'");
            mysql_query($query);
            move_uploaded_file($_FILES['nama_navhome']['tmp_name'], "../images/".$_FILES['nama_navhome']['name']);
