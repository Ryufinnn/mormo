...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Ubah | Teks dan Deskripsi</title>
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class='active'><a href="teksdes.php"><span class="glyphicon glyphicon-asterisk"></span><span>Teks dan Deskripsi</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <a href="../index.php" target="_blank" class="btn btn-success btn-large" role="button"><span class="glyphicon glyphicon-arrow-right"></span> Cek Halaman</a>
          <p>
            <h2>Ubah Teks dan Deskripsi</h2>
            <br/>
          </p>
          <form action="teksdes.php" method="post">
            <div class="form-group">
              <label>Teks Halaman yang Diubah</label>
                <div class="input-group">
                   <select name="id_tulisan">
            ...
            <div class="form-group">
              <label>Teks</label>
                <div class="input-group">
                  <textarea class="form-control" rows="5" name="desk_tulisan" id="desk_tulisan" required maxlenght="1000"></textarea>
                </div>
            </div>
          ...
          <?php
          $id_tulisan = $_POST['id_tulisan'];
          $wkt_upload = date('Y-m-d H:i:s');
          $kode = array("'", "?", "!", "-", "+", "&", "@", "*", "~", "|", "\n");
          $unicode = array("%27", "%3F", "%21", "%2D", "%2B", "%26", "%40", "%2A", "%7E", "%7E", "<br/>");
          $teksAwal = $_POST['desk_tulisan'];
          $desk_tulisan = str_replace($kode, $unicode, $teksAwal);
          if (isset($_POST['simpan'])){
            $query = mysql_query("UPDATE `teks` SET `desk_tulisan`='$desk_tulisan',`wkt_upload`='$wkt_upload' WHERE `id_tulisan`='$id_tulisan'");
            mysql_query($query);
            echo"<script>alert('Tulisan Berhasil Diubah!');</script>";
          }
          ?>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
